...
- make the var tag a unique object to avoid unifying with a (var _) vector and confusing it for a real var ([src/mk/datatypes.ss:52](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L52))
- try replacing state vector copy with manual updates using mutators ([src/mk/datatypes.ss:104](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L104))
- remove set-state-varid ([src/mk/datatypes.ss:123](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L123))
- rename state-or-failure? to maybe-state? ([src/mk/datatypes.ss:129](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L129))
- ensure that if two vars are unified, there is a definite order even in the goal so that we can read the rhs as always the 'value' when running constraints. also break two pairs into a conj of ==. then we can simplify the order checking inside the unifier ([src/mk/datatypes.ss:154](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L154))
- see if normalize-matcho adds anything to solve-matcho ([src/mk/datatypes.ss:173](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L173))
- revisit goal-cond once fresh is either explicit or removed ([src/mk/datatypes.ss:212](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L212))
- replace conj with make-conj or short circuiting conj* where possible ([src/mk/datatypes.ss:255](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L255))
- experiment with short circuiting conj and disj macros ([src/mk/datatypes.ss:262](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L262))
- make conj a macro but when it is just an identifier macro make it return a function of itself for use with higher order fns ([src/mk/datatypes.ss:263](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L263))
- remove conj-car ([src/mk/datatypes.ss:279](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L279))
- is conj-fold ever used? ([src/mk/datatypes.ss:315](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L315))
- convert constructor fns to constructed params of structure   ([src/mk/datatypes.ss:334](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L334))
- microbenchmark disj cdr that looks ahead instead of using base case to check for non disj ([src/mk/datatypes.ss:349](https://github.com/emdonahue/aiKanren/blob/main/src/mk/datatypes.ss#L349))
...
- make fresh insert fail checks between conjuncts to short circuit even building subsequent goals ([src/mk/ui.ss:14](https://github.com/emdonahue/aiKanren/blob/main/src/mk/ui.ss#L14))
- make conde do fail checks syntactically ([src/mk/ui.ss:22](https://github.com/emdonahue/aiKanren/blob/main/src/mk/ui.ss#L22))
- try applying constraint immediately when applied ([src/mk/ui.ss:141](https://github.com/emdonahue/aiKanren/blob/main/src/mk/ui.ss#L141))
- make fresh-vars non-recursive ala matcho ([src/mk/ui.ss:145](https://github.com/emdonahue/aiKanren/blob/main/src/mk/ui.ss#L145))
- make goal-cond automatically add a condition for trace goals when not compiling and make trace goals vanish when compiling (test (optimize-level) param? ([src/mk/tracing.ss:19](https://github.com/emdonahue/aiKanren/blob/main/src/mk/tracing.ss#L19))
- make all goals accept a list of states so that we can print only the code as written and the input and output states without having to multiplex the code points for the tracing interpreter ([src/mk/tracing.ss:35](https://github.com/emdonahue/aiKanren/blob/main/src/mk/tracing.ss#L35))
- DRY the matcho/exist/fresh calls to common calling interface. maybe use => cond interface ([src/mk/tracing.ss:44](https://github.com/emdonahue/aiKanren/blob/main/src/mk/tracing.ss#L44))
- might be able to fold proofs into standard dfs with parameters and get rid of special cps trace interpreter ([src/mk/tracing.ss:63](https://github.com/emdonahue/aiKanren/blob/main/src/mk/tracing.ss#L63))
- print unbound variables in substitution debugging by checking var id in state ([src/mk/tracing.ss:154](https://github.com/emdonahue/aiKanren/blob/main/src/mk/tracing.ss#L154))
