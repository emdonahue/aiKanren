...
- try ==> as =/=|== in case =/= might be more efficient for attribution/ ([src/mk/constraints.ss:14](https://github.com/emdonahue/aiKanren/blob/main/src/mk/constraints.ss#L14))
- do constraints need to manage recheck individually or is that just for matcho and disj? ([src/mk/constraints.ss:28](https://github.com/emdonahue/aiKanren/blob/main/src/mk/constraints.ss#L28))
- have typeo simplify == not simply succeed or fail ([src/mk/constraints.ss:40](https://github.com/emdonahue/aiKanren/blob/main/src/mk/constraints.ss#L40))
- create defconstraint that tags any matchos returned with the function pointer so they can dedup themselves ([src/mk/constraints.ss:111](https://github.com/emdonahue/aiKanren/blob/main/src/mk/constraints.ss#L111))
...
- try applying constraint immediately when applied ([src/mk/ui.ss:134](https://github.com/emdonahue/aiKanren/blob/main/src/mk/ui.ss#L134))
- make fresh-vars non-recursive ala matcho ([src/mk/ui.ss:138](https://github.com/emdonahue/aiKanren/blob/main/src/mk/ui.ss#L138))
