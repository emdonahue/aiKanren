(library (substitution-tests)
  ...
  (import (chezscheme) (substitution) (test-runner))
  ...
  (define (run-substitution-tests)
    ...
    (tassert "unify cars fail" (unify empty-substitution (cons 0 x0) (cons 1 0)) #f)
    (tassert "unify cdrs" (walk (unify empty-substitution (cons 0 x0) (cons 0 1)) x0) 1)
    (tassert "unify cdrs fail" (unify empty-substitution (cons x0 1) (cons 1 0)) #f)))
