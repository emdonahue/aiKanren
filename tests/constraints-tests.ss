(library (constraints-tests)
  ...
  (define (run-constraints-tests)
    ...
    (tassert "disunify free-ground" (constraint-disequality (run1 (x0) (=/= x0 0))) (list (cons x0 0)))
    (tassert "disunify ground-free" (constraint-disequality (run1 (x0) (=/= 0 x0))) (list (cons x0 0)))
    (tassert "disunify free-free" (map constraint-disequality (run1 (x0 x1) (=/= x0 x1)))
	     (list (list (cons x0 x1)) (list (cons x0 x1))))
