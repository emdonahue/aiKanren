(library (matcho-tests)
  ...
  (define (run-matcho-tests)
    ...
    (tassert "match ground list fail" (run1 () (let ([p '(1 2)]) (matcho ([p (a 1)]) (== a 1)))) (void))
    ...
    (tassert "match ground pair fail" (run1 () (let ([p '(1 . 2)]) (matcho ([p (a . b)]) (== a b)))) (void))
    (tassert "match ground pair succeed" (run1 () (let ([p '(1 . 1)]) (matcho ([p (a . b)]) (== a b)))) '())
