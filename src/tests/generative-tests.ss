...
(define (mk-expression e depth)
  (conde
    [(if (zero? depth) fail
         (conde
           [(matcho ([('conde lhs rhs) e]) (mk-expression lhs (fx1- depth)) (mk-expression rhs (fx1- depth)))]
           [(matcho ([('conj lhs rhs) e]) (mk-expression lhs (fx1- depth)) (mk-expression rhs (fx1- depth)))]))]
    
    [(matcho ([('noto goal) e]) (mk-expression/primitive goal))]
...
(define (mk-expression/primitive e)
  (conde
    ...
    [(matcho ([('numbero var) e]) (mk-var var))]
    [(matcho ([('symbolo var) e]) (mk-var var))]
    [(matcho ([('pairo var) e]) (mk-var var))]))

(define (mk-term t depth)
  (if (zero? depth) fail
      (conde
        [(== t '())]
        [(matcho ([(a . d) t]) (mk-term a (fx1- depth)) (mk-term d (fx1- depth)))]
...
(define (mk-term/presento t depth)
  (if (zero? depth) fail
      (conde
        ...
        [(== t 2)]
        [(== t (make-mk-var 1))]
        [(matcho ([(a . d) t]) (mk-term/presento a (fx1- depth)) (mk-term/presento d (fx1- depth)))])))
