...
(test-suite
 ...
 (exit)
 (tassert "reduce pconstraint =/=" (reduce-constraint2 (=/= x1 1) (numbero x1)) (list (numbero x1) (=/= x1 1) succeed (numbero x1)))
 (tassert "reduce pconstraint =/=!" (reduce-constraint2 (=/= x1 'symbol) (numbero x1)) (list (numbero x1) succeed succeed (numbero x1)))
 (tassert "reduce pconstraint ?==" (reduce-constraint2 (=/= x2 1) (numbero x1)) (list (numbero x1) (=/= x2 1) succeed (numbero x1)))
 (tassert "reduce pconstraint ?==!" (reduce-constraint2 (=/= x2 'symbol) (numbero x1)) (list (numbero x1) (=/= x2 'symbol) succeed (numbero x1)))
