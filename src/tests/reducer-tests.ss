...
(test-suite
 ...
 (tassert "reduce disj =/= both succeed asymmetric" (reduce-constraint (=/= x1 1) (disj (=/= x1 1) (=/= x1 1)) #t) (list (=/= x1 1) succeed))
 ...
 (tassert "reduce disj =/= both trivial" (reduce-constraint (=/= x1 1) (disj (=/= x1 1) (== x1 1)) #f) (list succeed succeed))
 (tassert "reduce disj =/= both trivial reverse" (reduce-constraint (=/= x1 1) (disj (== x1 1) (=/= x1 1)) #f) (list succeed succeed))
