...
(test-suite
 ...
 (tassert "noto does not mangle ctn" (run1 x1 (constraint (noto (symbolo x1)) (matcho3 ([x1 (1 2)]))) (== x1 '(1 2))) '(1 2))
 ...
 (tassert "presento unbound term" (run1 x1 (presento 1 x1)) (lambda (a) (and (disj? a) (equal? (disj-lhs a) (== x1 1)) (matcho4? (disj-rhs a)))))
