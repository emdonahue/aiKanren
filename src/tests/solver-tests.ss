...
;    (tassert "=/= & (fail|succeed)" (run1 (x1 x2) (disj (conj (=/= x1 1) (== x2 2)) (== x1 1)) (=/= x1 1)) (list (=/= x1 1) 2))
    ...
    (tassert "matcho fail" (simplify-=/=2 (matcho ([x1 (a . d)])) x1 1 (=/= x1 1)) (lambda (a) (and (fail? (list-ref a 0)) (matcho? (list-ref a 1)) (equal? (cddr a) (list succeed (=/= x1 1))))))
    ...
    (tassert "not matcho succeed" (simplify-=/=2 (noto (matcho ([x1 (a . d)]))) x1 1 (=/= x1 1)) (lambda (a) (and (succeed? (car a)) (noto? (cadr a)) (succeed? (caddr a)) (equal? (cadddr a) (=/= x1 1)))))
    ...
    (tassert "not matcho undecidable" (simplify-=/=2 (noto (matcho ([x1 (a . d)]))) x1 '(1 . 2) (=/= x1 '(1 . 2))) (lambda (a) (and (noto? (car a)) (noto? (cadr a)) (succeed? (caddr a))) (=/= x1 '(1 . 2))))
    ...
    (tassert "=/= satisfies|satisfied|unnormalized" (simplify-=/=2 (disj (=/= x1 1) (disj (symbolo x1) (=/= x2 2))) x1 1 (=/= x1 1)) (list (=/= x1 1) succeed succeed (=/= x1 1)))
    ...
    (tassert "=/= ==^|==^|==|==^" (simplify-=/=2 (disj (== x1 2) (disj (== x1 3) (disj (== x1 1) (== x1 4)))) x1 1 (=/= x1 1)) (list (== x1 1) (disj (== x1 2) (disj (== x1 3) (== x1 4))) succeed succeed))
    ...
    (tassert "=/= (satisfies|undecidable)|(satisfied|undecidable)" (simplify-=/=2 (disj (conj (=/= x1 2) (disj (=/= x1 1) (=/= x1 3))) (conj (=/= x1 4) (disj (symbolo x1) (=/= x1 5)))) x1 1 (=/= x1 1)) (list succeed (disj (=/= x1 2) (conj (=/= x1 4) (disj (symbolo x1) (conj (=/= x1 1) (=/= x1 5))))) succeed succeed))
