...
;    (tassert "=/= & (fail|succeed)" (run1 (x1 x2) (disj (conj (=/= x1 1) (== x2 2)) (== x1 1)) (=/= x1 1)) (list (=/= x1 1) 2))
    ...
    (tassert "== succeed" (simplify-=/=2 (== x1 1) x1 1 (=/= x1 1)) (list succeed fail fail (=/= x1 1)))
    ...
    (tassert "=/= fail" (simplify-=/=2 (=/= x1 1) x1 1 (=/= x1 1)) (list fail (=/= x1 1) succeed (=/= x1 1)))
    (tassert "=/= succeed" (simplify-=/=2 (=/= x1 2) x1 1 (=/= x1 1)) (list succeed (=/= x1 2) succeed (=/= x1 1)))
    (tassert "conj fail" (simplify-=/=2 (conj (== x1 1) (=/= x1 1)) x1 1 (=/= x1 1)) (list fail fail fail (=/= x1 1)))
    (tassert "matcho fail" (simplify-=/=2 (matcho ([x1 (a . d)])) x1 1 (=/= x1 1)) (list fail succeed fail (=/= x1 1)))
    ...
    (tassert "=/= satisfied|satisfied" (simplify-=/=2 (disj (=/= x1 1) (symbolo x1)) x1 1 (=/= x1 1)) (list fail (disj (=/= x1 1) (symbolo x1)) succeed (=/= x1 1)))
    (tassert "=/= satisfied|satisfied|unnormalized" (simplify-=/=2 (disj (=/= x1 1) (disj (symbolo x1) (=/= x2 2))) x1 1 (=/= x1 1)) (list (=/= x2 2) (disj (=/= x1 1) (disj (symbolo x1) (conj (=/= x1 1) (=/= x2 2)))) succeed (=/= x1 1)))
    (tassert "=/= unsatisfiable|satisfied" (simplify-=/=2 (disj (== x1 1) (symbolo x1)) x1 1 (=/= x1 1)) (list succeed succeed (symbolo x1) (=/= x1 1)))
    (tassert "=/= satisfied|unsatisfiable" (simplify-=/=2 (disj (symbolo x1) (== x1 1)) x1 1 (=/= x1 1)) (list succeed succeed (symbolo x1) (=/= x1 1)))
    (tassert "=/= satisfied|unsatisfiable|undecidable" (simplify-=/=2 (disj (symbolo x1) (disj (== x1 1) (=/= x1 2))) x1 1 (=/= x1 1)) (list succeed succeed (disj (symbolo x1) (conj (=/= x1 1) (=/= x1 2))) (=/= x1 1)))
    (tassert "=/= satisfied|undecidable" (simplify-=/=2 (disj (symbolo x1) (=/= x1 2)) x1 1 (=/= x1 1)) (list succeed (disj (symbolo x1) (conj (=/= x1 1) (=/= x1 2))) succeed (=/= x1 1)))
    (tassert "=/= unsatisfiable|undecidable" (simplify-=/=2 (disj (== x1 1) (=/= x1 2)) x1 1 (=/= x1 1)) (list succeed succeed (conj (=/= x1 1) (=/= x1 2)) (=/= x1 1)))
    (tassert "=/= undecidable|unsatisfiable" (simplify-=/=2 (disj (=/= x1 2) (== x1 1)) x1 1 (=/= x1 1)) (list succeed succeed (conj (=/= x1 1) (=/= x1 2)) (=/= x1 1)))
    (tassert "=/= undecidable|undecidable" (simplify-=/=2 (disj (=/= x1 2) (=/= x1 3)) x1 1 (=/= x1 1)) (list succeed (conj (=/= x1 1) (disj (=/= x1 2) (=/= x1 3))) succeed (=/= x1 1)))
