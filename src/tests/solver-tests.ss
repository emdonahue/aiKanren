...
;    (tassert "=/= & (fail|succeed)" (run1 (x1 x2) (disj (conj (=/= x1 1) (== x2 2)) (== x1 1)) (=/= x1 1)) (list (=/= x1 1) 2))
    ...
    (tassert "== succeed" (simplify-=/=2 (== x1 1) x1 1 (=/= x1 1)) (list (== x1 1) fail succeed (=/= x1 1)))
    (tassert "== undecidable" (simplify-=/=2 (== x1 (cons x2 x3)) x1 (cons x3 x2) (=/= x1 1)) (list (== x1 (cons x2 x3)) (== x1 (cons x2 x3)) succeed (=/= x1 1)))
    (tassert "=/= undecidable" (simplify-=/=2 (=/= x1 (cons x2 x3)) x1 (cons x3 x2) (=/= x1 1)) (list (=/= x1 (cons x2 x3)) (=/= x1 (cons x2 x3)) succeed (=/= x1 1)))
    (tassert "symbolo fail" (simplify-=/=2 (symbolo x1) x1 1 (=/= x1 1)) (list fail (symbolo x1) succeed (=/= x1 1)))
    (tassert "symbolo2 undecidable" (simplify-=/=2 (symbolo x1) x2 1 (=/= x1 1)) (list (symbolo x1) (symbolo x1) succeed (=/= x1 1)))
    (tassert "not numbero fail" (simplify-=/=2 (noto (numbero x1)) x1 1 (=/= x1 1)) (list fail (noto (numbero x1)) succeed (=/= x1 1)))
    (tassert "=/= fail" (simplify-=/=2 (=/= x1 1) x1 1 (=/= x1 1)) (list (=/= x1 1) succeed succeed (=/= x1 1)))
    (tassert "=/= succeed" (simplify-=/=2 (=/= x1 2) x1 1 (=/= x1 1)) (list succeed (=/= x1 2) succeed (=/= x1 1)))
    (tassert "conj fail" (simplify-=/=2 (conj (== x1 1) (=/= x1 1)) x1 1 (=/= x1 1)) (list (=/= x1 1) fail succeed (=/= x1 1)))
    (tassert "matcho fail" (simplify-=/=2 (matcho ([x1 (a . d)])) x1 1 (=/= x1 1)) (list fail succeed succeed (=/= x1 1)))
    (tassert "matcho2 undecidable" (simplify-=/=2 (matcho ([x1 (a . d)])) x2 1 (=/= x1 1)) (lambda (a) (and (matcho? (car a)) (matcho? (cadr a)) (succeed? (caddr a))) (=/= x1 1)))
    (tassert "not matcho succeed" (simplify-=/=2 (noto (matcho ([x1 (a . d)]))) x1 1 (=/= x1 1)) (lambda (a) (and (succeed? (car a)) (noto? (cadr a)) (succeed? (caddr a))) (=/= x1 1)))
    (tassert "matcho undecidable" (simplify-=/=2 (matcho ([x1 (a . d)])) x1 '(1 . 2) (=/= x1 1)) (lambda (a) (and (matcho? (car a)) (matcho? (cadr a)) (succeed? (caddr a))) (=/= x1 1)))
    (tassert "not matcho undecidable" (simplify-=/=2 (noto (matcho ([x1 (a . d)]))) x1 '(1 . 2) (=/= x1 1)) (lambda (a) (and (noto? (car a)) (noto? (cadr a)) (succeed? (caddr a))) (=/= x1 1)))
    (tassert "=/= satisfied|satisfies" (simplify-=/=2 (disj (=/= x1 1) (symbolo x1)) x1 1 (=/= x1 1)) (list (=/= x1 1) succeed succeed (=/= x1 1)))
    (tassert "=/= satisfies|satisfies" (simplify-=/=2 (disj (symbolo x1) (symbolo x1)) x1 1 (=/= x1 1)) (list fail (disj (symbolo x1) (symbolo x1)) succeed succeed))
    (tassert "=/= satisfied|satisfied|unnormalized" (simplify-=/=2 (disj (=/= x1 1) (disj (symbolo x1) (=/= x2 2))) x1 1 (=/= x1 1)) (list (=/= x2 2) (disj (=/= x1 1) (disj (symbolo x1) (conj (=/= x1 1) (=/= x2 2)))) succeed succeed))
    (tassert "=/= unsatisfiable|satisfied" (simplify-=/=2 (disj (== x1 1) (symbolo x1)) x1 1 (=/= x1 1)) (list succeed succeed (symbolo x1) succeed))
    (tassert "=/= satisfied|unsatisfiable" (simplify-=/=2 (disj (symbolo x1) (== x1 1)) x1 1 (=/= x1 1)) (list succeed succeed (symbolo x1) succeed))
    ...
    (tassert "=/= undecidable|undecidable" (simplify-=/=2 (disj (=/= x1 2) (=/= x1 3)) x1 1 (=/= x1 1)) (list succeed (conj (=/= x1 1) (disj (=/= x1 2) (=/= x1 3))) succeed succeed))
    (tassert "=/= recheck|undecidable" (simplify-=/=2 (disj (conj (=/= x2 2) (disj (== x1 1) (=/= x2 3))) (=/= x1 3)) x1 1 (=/= x1 1)) (list succeed succeed (disj (conj (=/= x2 2) (conj (=/= x1 1) (=/= x2 3))) (=/= x1 3)) succeed))
    (tassert "=/= satisfied|recheck" (simplify-=/=2 (disj (symbolo x1) (conj (=/= x2 2) (disj (== x1 1) (=/= x2 3)))) x1 1 (=/= x1 1)) (list succeed succeed (disj (symbolo x1) (conj (=/= x2 2) (conj (=/= x1 1) (=/= x2 3)))) succeed))
        (tassert "=/= satisfied|recheck" (simplify-=/=2 (disj (=/= x1 1) (=/= x1 2)) x1 1 (=/= x1 1)) (list succeed (=/= x1 1) succeed succeed))
