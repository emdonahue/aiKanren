...
;    (tassert "=/= & (fail|succeed)" (run1 (x1 x2) (disj (conj (=/= x1 1) (== x2 2)) (== x1 1)) (=/= x1 1)) (list (=/= x1 1) 2))
    ...
    (tassert "== succeed" (simplify-=/=2 (== x1 1) x1 1) (list succeed succeed fail))
    ...
    (tassert "conj fail" (simplify-=/=2 (conj (== x1 1) (=/= x1 1)) x1 1) (list fail (=/= x1 1) fail))
    (tassert "matcho fail" (simplify-=/=2 (matcho ([x1 (a . d)])) x1 1) (list fail fail fail))
